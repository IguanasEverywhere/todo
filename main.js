...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"loadProjects\": () => (/* binding */ loadProjects)\n/* harmony export */ });\n/* harmony import */ var _makeProject__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./makeProject */ \"./src/makeProject.js\");\n/* harmony import */ var _pushProjectToArray__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./pushProjectToArray */ \"./src/pushProjectToArray.js\");\n/* harmony import */ var _changeCurrentProject__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./changeCurrentProject */ \"./src/changeCurrentProject.js\");\n/* harmony import */ var _renderTaskDisplay__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./renderTaskDisplay */ \"./src/renderTaskDisplay.js\");\n/* harmony import */ var _pushTaskToProject__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./pushTaskToProject */ \"./src/pushTaskToProject.js\");\n\n\n\n\n\n\n\n\nconst loadProjects = () => {\n\n    let parsedProjects = JSON.parse(localStorage.getItem(\"projectNamesArray\"));\n    if (parsedProjects) {\n        parsedProjects.forEach(project => {\n            (0,_pushProjectToArray__WEBPACK_IMPORTED_MODULE_1__.pushToProjectArray)(project);            \n        });\n\n\n        _pushProjectToArray__WEBPACK_IMPORTED_MODULE_1__.projectArray.forEach(project => {\n            let projectNameBtn = document.createElement(\"button\");\n            projectNameBtn.classList.add(\"projectNameBtn\");\n            projectNameBtn.textContent = project.projectName;\n            projectBtnHolder.appendChild(projectNameBtn);\n            projectNameBtn.addEventListener(\"click\", () => {\n                (0,_changeCurrentProject__WEBPACK_IMPORTED_MODULE_2__.changeCurrentProject)(project.projectName);\n            });\n        });\n    }\n}\n\n\n\n//# sourceURL=webpack://todo/./src/loadProjects.js?");
